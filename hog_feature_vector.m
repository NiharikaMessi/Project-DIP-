...
% Gradients in X and Y direction. Ix is the gradient in X direction and Iy
...
figure,imshow(uint8(angle)); title('Angle in range(0,180)');
 figure,imshow(uint8(magnitude));title('Magnitude');
